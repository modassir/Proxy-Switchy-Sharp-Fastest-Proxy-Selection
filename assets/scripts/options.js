...
function checkPageParams() {
    ...
    if (params["firstTime"] == "true"){
        ...
        p1 = {'color':'blue','id':'10.3.100.209','name':'10.3.100.209','proxyConfigUrl':'','proxyExceptions':'localhost; 127.0.0.1; <local>','proxyFtp':'','proxyHttp':'10.3.100.209:8080','proxyHttps':'','proxyMode':'manual','proxySocks':'','socksVersion':4,'useSameProxy':true,};
        p2 = {'color':'blue','id':'10.3.100.210','name':'10.3.100.210','proxyConfigUrl':'','proxyExceptions':'localhost; 127.0.0.1; <local>','proxyFtp':'','proxyHttp':'10.3.100.210:8080','proxyHttps':'','proxyMode':'manual','proxySocks':'','socksVersion':4,'useSameProxy':true,};
        p3 = {'color':'blue','id':'10.3.100.211','name':'10.3.100.211','proxyConfigUrl':'','proxyExceptions':'localhost; 127.0.0.1; <local>','proxyFtp':'','proxyHttp':'10.3.100.211:8080','proxyHttps':'','proxyMode':'manual','proxySocks':'','socksVersion':4,'useSameProxy':true,};
        p4 = {'color':'blue','id':'10.3.100.212','name':'10.3.100.212','proxyConfigUrl':'','proxyExceptions':'localhost; 127.0.0.1; <local>','proxyFtp':'','proxyHttp':'10.3.100.212:8080','proxyHttps':'','proxyMode':'manual','proxySocks':'','socksVersion':4,'useSameProxy':true,};
        p5 = {'color':'blue','id':'144.16.192.213','name':'144.16.192.213','proxyConfigUrl':'','proxyExceptions':'localhost; 127.0.0.1; <local>','proxyFtp':'','proxyHttp':'144.16.192.213:8080','proxyHttps':'','proxyMode':'manual','proxySocks':'','socksVersion':4,'useSameProxy':true,};
        p6 = {'color':'blue','id':'144.16.192.216','name':'144.16.192.216','proxyConfigUrl':'','proxyExceptions':'localhost; 127.0.0.1; <local>','proxyFtp':'','proxyHttp':'144.16.192.216:8080','proxyHttps':'','proxyMode':'manual','proxySocks':'','socksVersion':4,'useSameProxy':true,};
        p7 = {'color':'blue','id':'144.16.192.217','name':'144.16.192.217','proxyConfigUrl':'','proxyExceptions':'localhost; 127.0.0.1; <local>','proxyFtp':'','proxyHttp':'144.16.192.217:8080','proxyHttps':'','proxyMode':'manual','proxySocks':'','socksVersion':4,'useSameProxy':true,};
        p8 = {'color':'blue','id':'144.16.192.218','name':'144.16.192.218','proxyConfigUrl':'','proxyExceptions':'localhost; 127.0.0.1; <local>','proxyFtp':'','proxyHttp':'144.16.192.218:8080','proxyHttps':'','proxyMode':'manual','proxySocks':'','socksVersion':4,'useSameProxy':true,};
        p9 = {'color':'blue','id':'144.16.192.245','name':'144.16.192.245','proxyConfigUrl':'','proxyExceptions':'localhost; 127.0.0.1; <local>','proxyFtp':'','proxyHttp':'144.16.192.245:8080','proxyHttps':'','proxyMode':'manual','proxySocks':'','socksVersion':4,'useSameProxy':true,};
        p10 = {'color':'blue','id':'144.16.192.247','name':'144.16.192.247','proxyConfigUrl':'','proxyExceptions':'localhost; 127.0.0.1; <local>','proxyFtp':'','proxyHttp':'144.16.192.247:8080','proxyHttps':'','proxyMode':'manual','proxySocks':'','socksVersion':4,'useSameProxy':true,};
        
        profile_vars = [p1,p2,p3,p4,p5,p6,p7,p8,p9,p10];
        // Add above proxies 
        for (index = 0; index < profile_vars.length; ++index) {
            ProfileManager.profiles[profile_vars[index].id] = profile_vars[index];
        }

        //Apply any one of the proxy
        ProfileManager.applyProfile(ProfileManager.profiles['10.3.100.211']);
